// https://juanpinzon-1992.blogspot.com/2017/06/materialize-table-pagination.html
...
$.fn.pageMe = function(opts){
    ...
    children.prop('hidden', true); //hide()
    children.slice(0, perPage).prop('hidden', false); //show()
    ...
    function goTo(page){
        ...
        children.prop('hidden', true).slice(startAt, endOn).prop('hidden', false);
